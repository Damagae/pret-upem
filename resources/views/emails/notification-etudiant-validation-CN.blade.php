...
<h2 style="font-family: sans-serif">Validation du projet par le Campus Numérique</h2>
...
<div style="font-family: sans-serif">
  <p> Votre demande de prêt {{ $num_eng }} ("{{ $nom_projet }}") vient d'être validée par le Campus Numérique. </p>
  <p> Vous pouvez récupérer votre matériel le {{ $date_debut }} au bureau {{ $bureau }}. </p>
  <p> Pour voir votre convention :</p>
